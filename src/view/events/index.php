      ...
      <section class="joinUs">
        ...
        <article class="dokkeuken">
          ...
          <section class="DkInfo">
            <h4>Dokkeuken</h4>
            <p>Wisselkeuken is een gedeelde horecaruimte waar koks en culinair geïnteresseerden die de mogelijkheid krijgen om hun concept uit te proberen of te experimenteren met voeding. Het is de bedoeling dat je je eigen benodigdheden en materiaal voorziet
              (geen wegwerp). Deze ruimte kan je gebruiken voor een onbepaalde periode, naargelang de noden van je idee of concept.</p>
        ...
        <article class="dokbewoners">
          ...
          <section class="DbInfo">
            <h4>Dokbewoners</h4>
            <p>DOK opent zijn deur voor zowel individuen en buurtbewoners als voor bedrijven, collectieven of organisaties. Wat er gebeurt op DOK wordt bepaald door de DOKbewoners. Voor het nieuwe seizoen is DOK altijd op zoek naar nieuwe DOKbewoners, residents,
              die DOK 2017 mee vorm en kleur willen geven met  creatieve manoeuvres</p>
